...
// The code for this is taken from: https://github.com/openai/openai-node/pull/235
...
// This is the core code. The rest is to track the progress of the fine-tuning.
async function mainShort() {
  let file = await client.files.create({
    file: fs.createReadStream('./files/input.jsonl'),
    purpose: 'fine-tune',
  });
